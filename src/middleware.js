...
export async function middleware(request) {
  ...
  if (!isAuthenticated && (url.pathname === "/about" || url.pathname === "/" || url.pathname === "/profile" || url.pathname === "/add-item")) {
...
export const config = {
  matcher: ["/about", "/", "/login", "/signup", "/profile", "/add-item"], // Keep all routes to handle them dynamically in the middleware
};
